    ...
    <section class="input-output-grid" style="position: relative">
      ...
      <section class="ai-output">
        <div class="string-wrapper">
          <svg
            v-if="isRequestSended.value && !output.value"
            xmlns="http://www.w3.org/2000/svg"
            ...
            <rect
              ...
              <animate
                ...
                calcMode="spline"
                keyTimes="0;0.5;1"
                values="31.599999999999998;38.5;38.5"
              ...
              <animate
                ...
                calcMode="spline"
                keyTimes="0;0.5;1"
                values="36.800000000000004;23;23"
                keySplines="0 0.5 0.5 1;0 0.5 0.5 1"
                begin="-0.2s"
                style="
                  animation-play-state: running;
        ...
        <div class="ai-output-actions">
          <el-dropdown trigger="click" :disabled="outputList.value.length <= 1">
            <el-button
              ...
              Variation's List<el-icon class="el-icon--right isActive"
                ><arrow-down
              /></el-icon>
            </el-button>
            <template #dropdown>
